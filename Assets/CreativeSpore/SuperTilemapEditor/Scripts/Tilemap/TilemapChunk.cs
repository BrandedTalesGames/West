...
#region Monobehaviour Methods
        ...
        void UpdateMaterialPropertyBlock()
        {
            ...
            {
                var color = ParentTilemap.TintColor * ParentTilemap.ParentTilemapGroup.UnselectedColorMultiplier;
                m_matPropBlock.SetColor("_Color", color);
                m_matPropBlock.SetColor("unity_SpriteColor", color);
            }
            else
#endif
            {
                var color = ParentTilemap.TintColor;
                m_matPropBlock.SetColor("_Color", color);
                m_matPropBlock.SetColor("unity_SpriteColor", color);
            }
            ...
            m_matPropBlock.SetVector("unity_SpriteProps", new Vector4(1, 1, -1, 0));
